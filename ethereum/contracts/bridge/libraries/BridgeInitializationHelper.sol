...
import {TransactionValue} from "../../zksync/libraries/TransactionValue.sol";
...
library BridgeInitializationHelper {
    ...
    function requestDeployTransaction(
        ...
        _zkSync.requestL2Transaction(
            ...
            TransactionValue(0, _deployTransactionFee, DEPLOY_L2_BRIDGE_COUNTERPART_GAS_LIMIT,REQUIRED_L2_GAS_PRICE_PER_PUBDATA ),
            deployCalldata,
            _factoryDeps,
            msg.sender
        );
